...
class LBFGS:
    ...
    def lb1 ( self, iprint , nfun , gnorm , x , f , g , stp , finish ):
        ...
        if self.iter == 0:
            ...
            if  iprint [ 2 -1] >= 1:
                ...
                print str
            print( "*************************************************" )
            print( "\ti\tnfn\tfunc\tgnorm\tsteplength" )
        else:
            ...
            if iprint [ 1 -1] != 0:
                if  (self.iter - 1) % iprint [ 1 -1] == 0 or finish == True:
                    if  iprint [ 2 -1] > 1 and self.iter > 1 :
                        print( "\ti\tnfn\tfunc\tgnorm\tsteplength" );
                    print( "\t%d\t%d\t%f\t%f\t%f" % (self.iter,nfun,f,gnorm,stp[0] ) )
                else:
                    return
            else:
    ...
    def lbfgs(self, x,func):
        ...
        if self.iter == 0:
            ...
            self.lb1(self.iprint, self.nfun, self.gnorm, x[0], f[0], g[0], self.stp, self.finish)
        ...
        while True:
            ...
            self.mcsrch_instance.mcsrch(x, f, g, self.s[-1], self.stp, func, self.ftol, self.gtol, self.xtol, self.maxfev, self.stpmin, self.stpmax, self.nfev, self.info)
