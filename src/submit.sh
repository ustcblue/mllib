...
spark-submit --master yarn-client --executor-memory 20G --driver-memory 2g --num-executors 2 --executor-cores 4 --py-files utils.py train.SGD.accumulator.py #train.SGD.broadcast.py
#train.py
